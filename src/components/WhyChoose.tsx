      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-6xl font-black text-white mb-6 tracking-tight animate-slide-up">
            WHY CHOOSE <span className="text-red-500">C.A.P.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {reasons.map((reason, index) => (
            ...
            >
              {/* Icon */}
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-red-600 to-red-700 text-white rounded-full mb-6 group-hover:from-red-700 group-hover:to-red-800 transition-all duration-300 transform group-hover:scale-110 shadow-xl">
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black rounded-2xl p-8 lg:p-12 border border-gray-800 animate-fade-in" style={{ animationDelay: '1s' }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="border-r border-gray-700 last:border-r-0">
              <div className="text-4xl lg:text-6xl font-black text-red-500 mb-2 animate-pulse-slow">15+</div>
              <div className="text-gray-400 font-semibold tracking-wide">YEARS EXPERIENCE</div>
            </div>
            <div className="border-r border-gray-700 last:border-r-0">
              <div className="text-4xl lg:text-6xl font-black text-red-500 mb-2 animate-pulse-slow" style={{ animationDelay: '0.2s' }}>50K+</div>
              <div className="text-gray-400 font-semibold tracking-wide">SATISFIED CUSTOMERS</div>
            </div>
            <div>
              <div className="text-4xl lg:text-6xl font-black text-red-500 mb-2 animate-pulse-slow" style={{ animationDelay: '0.4s' }}>24/7</div>
